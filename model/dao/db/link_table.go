 ...
 * @LastEditors: Adxiong
 * @LastEditTime: 2023-03-19 21:45:55
 */
package db
...
// Link [...]
type Link struct {
	ID       uint       `gorm:"primaryKey;column:id;type:int unsigned;not null;comment:'自增id'" json:"id"`         // 自增id
	Name     string     `gorm:"column:name;type:varchar(255);not null;comment:'link名称'" json:"name"`              // link名称
	LinkID   uint       `gorm:"column:link_id;type:int unsigned;not null;comment:'link_id'" json:"link_id"`       // link_id
